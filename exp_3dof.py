...
class BaseExp:
    ...
    def train(self, params):
        ...
        scheduler = MultiStepLR(optimizer, [5000, 10000, 35000], gamma=0.1)
        ...
        # with open('./results/3dof/lh_L{}_{}_{}.json'.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tol', default=1e-16, type=float)
